...
(function() {
  Formbuilder.registerField('photo', {
    order: 25,
    view: "<div style='text-align: center;' class='input-line'><i class='fa fa-camera fa-5x'></i></div>",
    edit: "",
    addButton: "<span class=\"symbol\"><span class=\"fa fa-camera\"></span></span> Photo"
  });
...
(function() {
  Formbuilder.registerField('signature', {
    order: 25,
    view: "<div  style='text-align: center;' class='input-line'><i class='fa fa-pencil fa-5x'></i></div>",
    edit: "",
...
(function() {
  Formbuilder.registerField('customer', {
    order: 25,
    view: '<div class="subtemplate-wrapper fb-field-wrapper output">  <label></span></label><div class="input-line"><span class="firstname">          <input type="text"><label>First Name</label> </span> <span class="lastname"><input type="text"><label>Last Name</label></span> </div> <div class="input-line"><span class="street"><input     type="text" style="width: 365px"> <label>Address</label></span> </div><div class="input-line"><span class="city"><input type="text"><label>City</label> </span><span class="state"> <input     type="text"> <label>State / Province / Region</label></span> </div><div class="input-line"> <span class="zip"><input type="text"><label>Zipcode</label> </span> <span class="country">        <select><option>United States</option></select><label>Country</label></span></div><div class="input-line"> <span class="phone"> <input type="text"><label>Phone</label></span><span            class="Email"><input type="text"><label>Email</label> </span> </div></div>',
    edit: "",
...
this["Formbuilder"]["templates"]["edit/label_description"] = function(obj) {
  ...
  with (obj) {
    ...
    ((__t = ( Formbuilder.options.mappings.LABEL )) == null ? '' : __t) +
    '\' />\n<textarea id="editor" data-rv-input=\'model.' +
...
this["Formbuilder"]["templates"]["view/base_non_input"] = function(obj) {
  ...
  with (obj) {
    __p += '';
    ((__p = ( Formbuilder.templates['view/duplicate_remove']({rf: rf}) )) == null ? '' : __t) +
    '\n</div>\n';
